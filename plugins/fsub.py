...
@Bot.on_message(filters.command('add_fsub') & filters.private & filters.user(ADMIN_ID))
...
@Bot.on_message(filters.command('del_fsub') & filters.private & filters.user(ADMIN_ID))
...
@Bot.on_message(filters.command('fsub_chnl') & filters.private & filters.user(ADMIN_ID))
